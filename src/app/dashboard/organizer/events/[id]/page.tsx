    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          <Button variant="outline" className="gap-2" onClick={() => router.push(`/dashboard/organizer/events/create?edit=${eventId}`)}>
            <Settings className="w-4 h-4" /> Edit Event
          </Button>
          <Button className="gap-2 shadow-lg shadow-primary/20" onClick={() => router.push(`/dashboard/organizer/events/${eventId}/announcements`)}>
                      ...
                      {applications.map(app => (
                        <tr key={(app as any).id} className="hover:bg-secondary/5 transition-colors">
                          ...
                          <td className="px-6 py-4 text-right">
                            <DropdownMenu>
                              <DropdownMenuTrigger className="inline-flex items-center justify-center h-8 w-8 rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-ring">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {event.committees.map(c => (
                      <button
                        ...
                        className={`px-4 py-1.5 rounded-full text-sm font-medium transition-colors border ${selectedCommittee === c.name
